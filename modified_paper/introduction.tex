...
The algorithm in \cite{Wu2009_LRPC} uses a decision tree to assign provisional labels and an array-based union-find datastructure
to store label equivalence information. The algorithm in \cite{He2012_ARun} employs a special scan order over the data and three linear
